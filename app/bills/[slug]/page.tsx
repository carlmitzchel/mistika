  ...
  const handleJoin = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const share = data.shares.find(
        (s: Share) => s.participantId === match.id,
      );
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4 bg-[#FFFBF5]">
        <div className="doodle-card p-8 w-full max-w-sm text-center">
          ...
          <p className="font-bold mt-3">Bill Deleted</p>
          <p className="text-sm text-[#6B7280] mt-1">
            This bill has been deleted by the organizer.
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4 bg-[#FFFBF5]">
        <div className="doodle-card p-8 w-full max-w-sm flex flex-col items-center gap-4 text-center">
          ...
          {error && <p className="text-sm font-bold text-[#FF6B6B]">{error}</p>}
          <form
            onSubmit={handleJoin}
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-6">
      ...
      <div className="doodle-card p-6 mb-4 text-center rotate-[-0.4deg]">
        <p className="text-sm font-bold text-[#6B7280] uppercase tracking-wide mb-1">
          Your share
        </p>
        <p
      ...
      {step === "pay" && (
        <div className="doodle-card p-4 mt-4 rotate-[-0.3deg]">
          ...
          {payError && (
            <p className="text-sm font-bold text-[#FF6B6B] mb-3">{payError}</p>
          )}
